...
test('signature is equal for findings differing only by identifier/line', () => {
  const a = {
    ...
    message: "Missing id in 'ContactDetails' query at line 12",
  };
  const b = {
    agent: 'data-integrity',
    category: 'graphql',
    file: 'src/components/Foo/B.tsx',
    message: "Missing id in 'TaskList' query at line 88",
  };
